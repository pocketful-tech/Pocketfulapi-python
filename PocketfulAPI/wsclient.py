...
from PocketfulAPI.packetDecoder import decodeDetailedMarketData, decodeCompactMarketData, decodeSnapquoteData, decodeOrderUpdate, decodeTradeUpdate
...
detailed_fno_marketdata_response = {}
...
def get_detailed_fno_marketdata():
    return detailed_fno_marketdata_response
...
def on_message(ws, message):
    ...
    if mode == 1:
        ...
        # print(detailed_marketdata_response)
        if bool(res):
